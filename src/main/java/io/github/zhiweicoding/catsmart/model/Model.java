...
import static io.github.zhiweicoding.catsmart.model.Device.State.OFFLINE;
import static io.github.zhiweicoding.catsmart.model.Device.State.ONLINE;
import static io.github.zhiweicoding.catsmart.model.Device.randomID;
...
public class Model {
    ...
    public static final ObservableList<OrderEntity> orderEntities;
    ...
    static {
        ...
        orderEntities = FXCollections.observableArrayList(new ArrayList<>());
    }
}
